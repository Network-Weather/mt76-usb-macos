...
instrument does. Note the asymmetry the triage found: the MT7921 blobs are plaintext
(6.03 bits/byte, ~2000 real strings), the MT7925 blobs are opaque (7.96–8.00 bits/byte).
Anything learned by reading MT7921 firmware does not transfer to the MT7925 by the same
route.
