...
| Offline behavior | 2,014 pytest cases on the R32 integration branch, including synthetic Python/C parity and injectable USB/register faults; no adapter or firmware required |
