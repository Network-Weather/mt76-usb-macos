...
| `mt76_histogram` records; `mt76_histogram_acquisition.HistogramGuard` | `mt76_histogram.h`, `mt76_histogram_acquisition.h` | Distinct old ordinary/new timer profiles, strict bounds, wide totals/raw labels; matching guarded begin/finish/restore, shared fault fixtures and12 native/Python live runs. Unknown coverage/calibration and pending-timer reload requirements retained ([contract](HISTOGRAM_API.md)) |
