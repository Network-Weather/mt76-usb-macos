...
| `mt76_histogram` pure request/ACK/event/legacy-bank records | `mt76_histogram.h` | Distinct old ordinary/new timer profiles, strict bounds, wide totals and raw threshold labels. Python repeated session acquisition passes; native live and public lifetime/cleanup still gated ([contract](HISTOGRAM_API.md)) |
