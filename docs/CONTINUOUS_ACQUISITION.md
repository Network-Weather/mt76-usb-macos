...
Original implementation: `feat/continuous-acquisition` through `0c2fffa`, based on
`main` at `055e881`. Integrated with post-PR #31 main and the R32 plan on
`feat/measurement-api`, 2026-09-06; not yet merged into main or released.
...
- The integrated baseline passes 1,687 pytest tests, native tests and ASan/UBSan,
  formatting/lint/docs checks, sdist/wheel builds and dependency checks. These are
  new offline integration results, not a new hardware run or soak claim.
